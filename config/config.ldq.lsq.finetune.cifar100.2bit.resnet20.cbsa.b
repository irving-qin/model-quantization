...
case='cifar100-ldq-lsq-finetune-2bit-pytorch-order_cb-wd1e-4-wt_qg1_var-mean-real_skip-sgd_0'
keyword='cifar100,origin,cbsa,fix_pooling,singleconv,fix,ReShapeResolution,real_skip,dorefa,lsq'

pretrained='cifar100-ldn-stratch-fp-pytorch-order_cb-wd1e-4-sgd_0-model_best.pth.tar'
